...
| الحساب اليومي | يوم Binance Spot 1D عند 00:00 UTC هو الحد اليومي الوحيد؛ اليوم و7 أيام والتراكمي محفوظة. لا يوجد Reset عند منتصف الليل المحلي، والخسائر والتراجع من القمة لا يُمحَيان عند عبور حد اليوم. يستمر تقييم المراكز أثناء الإيقاف. |
...
- لا يوجد جلب بيانات إضافي إذا لم توجد مراكز أو أوامر مفتوحة. أثناء وجودها، تُحدَّث البيانات كل 5 ثوانٍ بتوازٍ محدود. لا يُكتب تقييم جديد عندما لم تتغير قيمة الحساب أو اليوم.
...
- تعتمد اليوميات على عينات التقييم وحدّ يوم Binance 1D عند 00:00 UTC. التغير عبر فجوة دون بيانات يُسجل عند أول عينة لاحقة؛ لا تُخترع قيمة عند الحد اليومي. الإجمالي والرسوم والتراجع يظلون محفوظين.
