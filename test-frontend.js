...
for(const file of ['index.html','public/index.html']){
 ...
 assert(s.includes('9.8.1-FREE-MANAGEMENT-KLINE-TRUTH-MEMORY-SAFE'),'NET-PNL 24h release version missing');
 ...
 assert(s.includes('5m/5د')&&s.includes('15m/15د')&&s.includes('1D/يوم')&&s.includes('03:01 بتوقيت مكة'),'multi-timeframe schedule explanation missing');
