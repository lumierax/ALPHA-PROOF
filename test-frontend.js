...
for(const file of ['index.html','public/index.html']){
 ...
 assert(s.includes('9.5.0-LAB-AI-OMEGA-CORTEX'),'CORTEX release version missing');
...
assert(b.includes("'aiBrain'")&&b.includes("'aiCheckpoints'"),'GitHub backup must isolate brain and checkpoints in IndexedDB');assert(b.includes("'marketBrain'")&&b.includes("'marketRuntime'")&&b.includes("'marketDataset'")&&b.includes("'marketCheckpoints'"),'GitHub backup must isolate Market AI stores in IndexedDB');assert(b.includes("'forgeBrain'")&&b.includes("'forgeCheckpoints'")&&b.includes("'forgeEvents'"),'GitHub backup must isolate CORTEX brain/checkpoints/research events in IndexedDB');assert(b.includes('alpha-proof-omega-cortex-foundation/3')&&b.includes('CORTEX-RESEARCH-V3'),'local CORTEX foundation lineage missing');assert(b.includes('Statistical Firewall')&&b.includes('Feature Tribunal')&&b.includes('Multiple-testing tax'),'CORTEX V3 safety/research UI missing');assert(b.includes('async function localObserveMarketAI')&&b.includes('async function localMarketAiLoad'),'local Market AI foundation missing');
